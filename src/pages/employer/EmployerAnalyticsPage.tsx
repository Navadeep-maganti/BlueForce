...
export const EmployerAnalyticsPage: React.FC<EmployerAnalyticsPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-xl sm:text-2xl font-black text-navy">Recruitment & Hiring Analytics</h1>
        <p className="text-xs text-muted">
          Real-time metrics on candidate throughput, time-to-hire, and regional blue-collar skill supply.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="kc-card p-5 bg-white border">
          <span className="text-xs font-bold text-muted uppercase block mb-1">Avg Time to Hire</span>
        ...
        <div className="kc-card p-5 bg-white border">
          <span className="text-xs font-bold text-muted uppercase block mb-1">Verification Pass Rate</span>
        ...
        <div className="kc-card p-5 bg-white border">
          <span className="text-xs font-bold text-muted uppercase block mb-1">Interview Show-Up Rate</span>
        ...
        <div className="kc-card p-5 bg-white border">
          <span className="text-xs font-bold text-muted uppercase block mb-1">Cost Per Plant Hire</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 kc-card p-6 bg-white border space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-sm text-navy">Recruitment Conversion Funnel</h3>
            ...
            {funnelData.map((item, idx) => (
              <div key={idx} className="space-y-1">
                <div className="flex items-center justify-between text-xs font-semibold">
                  ...
                  <span className="text-navy font-bold">{item.count} candidates ({item.percent}%)</span>
                </div>
        ...
        <div className="lg:col-span-5 kc-card p-6 bg-white border space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-sm text-navy">Regional Trade Supply Index</h3>
