    ...
    <div className="space-y-5 max-w-7xl mx-auto">
      ...
      <div className="kc-card p-4 sm:p-5 bg-white border flex flex-col sm:flex-row sm:items-center justify-between gap-3.5">
        <div className="flex items-center gap-3.5">
          <img
            ...
            alt={worker.fullName}
            className="w-12 h-12 rounded-xl object-cover border border-primary/30 shadow-xs"
          />
          <div>
            <div className="flex items-center gap-1.5">
              <h1 className="text-base sm:text-lg font-black text-navy">{t.workerDashboard.greeting} 👋</h1>
            ...
            <p className="text-[11px] text-muted flex items-center gap-1 mt-0.5">
              <MapPin className="w-3 h-3" /> {worker.location} • Status: Available Now
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-4 kc-card p-4 sm:p-5 bg-white border flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-muted">
                {t.workerDashboard.profileStrength}
              </span>
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                <span className="flex items-center gap-1.5 text-slate-700 text-[11px] font-medium">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> Aadhaar Biometric
                </span>
                <span className="badge badge-verified text-[9px]">Verified</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                <span className="flex items-center gap-1.5 text-slate-700 text-[11px] font-medium">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> ITI NCVT Diploma
                </span>
                <span className="badge badge-verified text-[9px]">Verified</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                <span className="flex items-center gap-1.5 text-slate-700 text-[11px] font-medium">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> Proof of Work (2 Items)
                </span>
                <span className="badge badge-verified text-[9px]">Approved</span>
              </div>
            </div>
          </div>
          ...
          >
            Edit Digital Identity <ChevronRight className="w-3.5 h-3.5" />
          </button>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-blue-200">
              Recommended skill: <strong>PLC Troubleshooting & Ladder Logic</strong> (+₹8,000 avg salary boost).
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            <h2 className="text-base font-bold text-navy flex items-center gap-1.5">
              ...
              {t.workerDashboard.recommendedJobs}
            </h2>
            <p className="text-[11px] text-muted">
              Ranked with explainable compatibility scores for your trade credentials
            </p>
          </div>
          <button
            onClick={() => onNavigate('/worker/jobs')}
